...
_dll.openmc_get_convergence_tally.argtypes = [
        POINTER(POINTER(c_double)), POINTER(c_int)]
_dll.openmc_get_convergence_tally.restype = c_int
...
_init_mesh_egrid_args = [c_int, _array_1d_int, c_double, c_double, c_int]
